Depth First Search (DFS) is a graph traversal method that starts from a spurce vertex and explores each path completely before backtracking and exploring other paths. To avoid revisiting nodes in graphs in cycles, a visited array is used to track visited vertices.
...
\begin{itemize}
  ...
  \item This continues until all vertices reachable from the start are visited.
\end{itemize}
